...
CONNECTION_SRC = $(SRCDIR)/CONNECTION.cob
VIEW_REQUESTS_SRC = $(SRCDIR)/ViewRequests.cob
MANAGE_REQUESTS_SRC = $(SRCDIR)/ManageRequests.cob
DISPLAY_NETWORK_SRC = $(SRCDIR)/DisplayNetwork.cob
...
$(TARGET): $(MAIN_SRC) $(CREATE_SRC) $(LOGIN_SRC) $(NAV_SRC) $(PROFILE_STOR_SRC) $(PROFILE_LOAD_SRC) $(VIEW_PROFILE_SRC) $(SEARCH_PROFILE_SRC) $(CONNECTION_SRC) $(VIEW_REQUESTS_SRC) $(MANAGE_REQUESTS_SRC) $(DISPLAY_NETWORK_SRC)
	@echo "Compiling and linking $(TARGET)..."
	@mkdir -p $(BINDIR)
	$(COBC) $(COBCFLAGS) -I$(COPYDIR) -o $(TARGET) $(MAIN_SRC) $(CREATE_SRC) $(LOGIN_SRC) $(NAV_SRC) $(PROFILE_STOR_SRC) $(PROFILE_LOAD_SRC) $(VIEW_PROFILE_SRC) $(SEARCH_PROFILE_SRC) $(CONNECTION_SRC) $(VIEW_REQUESTS_SRC) $(MANAGE_REQUESTS_SRC) $(DISPLAY_NETWORK_SRC)
